...
Engine::PrimaryType::Vector2& Engine::PrimaryType::Vector2::operator=(const Engine::PrimaryType::Vector2& _other)
{
	x = _other.x;
	y = _other.y;
	return *this;
...
Engine::PrimaryType::Vector2 Engine::PrimaryType::Vector2::operator+(const Engine::PrimaryType::Vector2& _other) const
{
...
Engine::PrimaryType::Boolean Engine::PrimaryType::Vector2::operator==(const Engine::PrimaryType::Vector2& _other) const
{
