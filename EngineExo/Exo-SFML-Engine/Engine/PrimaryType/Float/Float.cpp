...
const Engine::PrimaryType::Float Engine::PrimaryType::Float::NaN = NAN;
...
Engine::PrimaryType::Boolean Engine::PrimaryType::Float::IsPositifInfinite(const Float& _value)
{
    return _value == PositiveInfinity;
}

Engine::PrimaryType::Boolean Engine::PrimaryType::Float::IsNegatifInFinite(const Float& _value)
{
