...
Engine::UI::TextField::TextField() : super()
{
    ...
    inputDefaultText = inputText = "test";
}
...
Engine::UI::TextField::TextField(const char* _defaultText, const PrimaryType::Vector2& _size) :self(_defaultText, _defaultText, _size) { }
